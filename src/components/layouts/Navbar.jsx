...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      {/* mobile menu */}
      {isMenuOpen && (
  <div className="fixed top-16 left-0 w-full h-full bg-gradient-to-b from-white to-orange-50 z-40 flex flex-col items-center space-y-5 py-10 px-6 shadow-2xl backdrop-blur-sm">
    <a
      href="#"
