  ...
  return (
    <div>
      ...
      <section className="min-h-[80vh] relative bg-gray-100 rounded-xl overflow-hidden m-4">
        ...
        />
        <div className="relative md:top-70 lg:right-70 z-10 p-10 max-w-4xl mx-auto text-white">
          <h1 className="text-4xl font-bold mb-2">Get certified</h1>
          <p className="text-lg mb-6">
            100+ certification courses. 100% online
          </p>
          <div className="flex items-center bg-white rounded shadow-md md:p-2 max-w-md">
            <input
              type="text"
